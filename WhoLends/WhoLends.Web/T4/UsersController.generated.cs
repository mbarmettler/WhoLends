...
namespace WhoLends.Web.Controllers
{
    public partial class UsersController
    {
        ...
        {
            public readonly string id = "id";
            public readonly string userVM = "userVM";
        }
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_UsersController : WhoLends.Web.Controllers.UsersController
    {
        ...
        [NonAction]
        partial void CreateOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, WhoLends.Data.User user);

        [NonAction]
        public override System.Web.Mvc.ActionResult Create(WhoLends.Data.User user)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Create);
        ...
        [NonAction]
        partial void EditOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, WhoLends.ViewModels.UserViewModel userVM);

        [NonAction]
        public override System.Web.Mvc.ActionResult Edit(WhoLends.ViewModels.UserViewModel userVM)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Edit);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "userVM", userVM);
            EditOverride(callInfo, userVM);
            return callInfo;
        }
